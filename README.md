...
3. [Done, without styling] When clicking on a class, display the minimum required statistics for that class
...
6. [Done] Save the character(s) to an API so they can be retrieved when the app starts next time. 
